...
data_filtered = data_filtered[~((data_filtered['Global_AVG'] > 600) & (data_filtered['Global_AVG'] == data_filtered['Diffuse_AVG']))]
data_filtered = data_filtered[data_filtered['Diffuse_AVG'] <= 650]
